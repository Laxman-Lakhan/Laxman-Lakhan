...
def main():
    ...
    return (ac.plot([ratings_list, performance_list], {'height': 15, 'format':'{:4.0f}', 'colors':[ac.default, ac.black]})), ratings_list, list(Chess_df['Played'])[::-1][0].strftime('%a, %d-%b-%Y %I:%M %p %Z')
